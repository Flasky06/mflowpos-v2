      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        ...
        <div className="flex items-center gap-3 shrink-0 flex-wrap sm:flex-nowrap">
          ...
          <button
            ...
            className="p-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl transition-all border border-slate-200 flex items-center justify-center shrink-0 cursor-pointer"
